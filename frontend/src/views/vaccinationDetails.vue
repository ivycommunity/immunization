  ...
  <div class="min-h-screen bg-[#F8F8FF] text-[#02343B] py-12 px-6">
    <section class="max-w-6xl mx-auto">
      ...
      <div class="flex justify-between items-center mb-8">
        <input v-model="searchQuery" type="text" placeholder="Search vaccines..."
        ...
        <table class="w-full">
          ...
          <tbody>
            <tr v-for="vaccine in filteredVaccines" :key="vaccine.id"
              ...
              <td class="p-4">
                <button @click="openDetails(vaccine)"
    ...
    <div v-if="selectedVaccine" class="fixed inset-0 bg-[#02343B]/90 flex items-center justify-center p-6">
      <div class="bg-[#121212] rounded-lg p-8 max-w-2xl w-full relative">
        <button @click="selectedVaccine = null" class="absolute top-4 right-4 text-[#F8F8FF] hover:text-[#04A699]">
          &times;
        </button>
