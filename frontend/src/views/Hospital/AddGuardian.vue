            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <form @submit.prevent="submitForm">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="first_name" class="block text-sm text-gray-600 mb-1">First Name<span
                            ...
                            <div>
                                <label for="last_name" class="block text-sm text-gray-600 mb-1">Last Name<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="email" class="block text-sm text-gray-600 mb-1">Email Address<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="phone_number" class="block text-sm text-gray-600 mb-1">Phone Number<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="gender" class="block text-sm text-gray-600 mb-1">Gender<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="role" class="block text-sm text-gray-600 mb-1">Role<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                                <select id="role" v-model="form.role" type="text"
                                    class="w-full p-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required>
                            ...
                            <div>
                                ...
                                <select id="country" name="country" v-model="form.nationality"
                                    class="w-full p-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required>
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="national_id" class="block text-sm text-gray-600 mb-1">National ID<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="date_of_birth" class="block text-sm text-gray-600 mb-1">Date of
                                    Birth<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                                <div class="relative">
                            ...
                            <div>
                                <label for="address" class="block text-sm text-gray-600 mb-1">Address<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="marital_status" class="block text-sm text-gray-600 mb-1">Marital
                                    Status<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="next_of_kin" class="block text-sm text-gray-600 mb-1">Next of Kin<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="next_of_kin_contact" class="block text-sm text-gray-600 mb-1">Next of Kin
                                    Contact<span
                                        style="color: red !important; display: inline; float: none;">*</span></label>
                            ...
                            <div>
                                <label for="no_of_children" class="block text-sm text-gray-600 mb-1">Number of Children
