  ...
  <userRegistrationLayout topBartitle="register">
    <div class="flex flex-wrap items-center justify-between box-border bg-white">
      ...
      <div class="w-full text-center mb-4">
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold text-[#432C81]">Register</h2>
      </div>
      ...
      <div class="w-full max-w-md mx-auto">
        <form @submit.prevent="handleSubmit" class="flex flex-col gap-6">
          ...
          <div class="text-center text-[#82799D]">
            Don't have an account? <a href="/user/login" class="text-[#432C81] font-medium">Log in</a>
          </div>
        </form>
      </div>
    </div>
